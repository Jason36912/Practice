...
my.remove_background_from_img_file(img_file_path='D:/DSC.jpg', size="regular")
#reBG = my.__output_file__(response=,new_file_name='removeBG.jpg')
import cv2 as cv

# img_file = open('D:/DSC.jpg', 'rb')
# #reBG = cv.imread('d:/'+'img_file.name + "_no_bg.png"')
# reBG = cv.imread('D:/DSC.jpg_no_bg.png"')
# #reBG.shape
# cv.imshow('removeBG',reBG)
# cv.waitKey(0)
